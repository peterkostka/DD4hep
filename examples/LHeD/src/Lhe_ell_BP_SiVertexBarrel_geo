...
//    Volume     lay_vol   (lay_nam,lay_tub,air);         // Create the layer envelope volume.
     Volume     lay_vol   (lay_nam,envElTube,air);         // Create the layer envelope volume.
...
//      double phi_incr     = (M_PI) / n_circ;         // Phi increment for one module
...
DECLARE_DETELEMENT(Lhe_ell_BP_SiVertexBarrel,create_detector)
