...
//for compact_lowE_Fhe_dip_sol_ell.xml
//-------------------------------------------------------------------------------------------------
{gROOT->Reset();
...
int HcalPlug_fwd_layers=57+110+129;
...
int HcalPlug_bwd_layers=44+84+110;
...
int EcalPlug_bwd_layers=26+32+1;
...
cout << " -----------------total Si area for lowE_Fhe det. (m^2) = " << sumall << endl;//total Silicon area 
float number_of_reaout_channel=sumall*47059;
cout << " -----------------number of readout channels for lowE_Fhe det. = " << number_of_reaout_channel << endl;//number of readout channel
...
int HcalBarrel_layers1=10;
int HcalBarrel_layers2=24;
int HcalBarrel_layers3=34;
...
float HcalBarrel_thickness=28.5+75.6+124.1;
...
int HcalEndcap_fwd_layers=25+30+36;
...
int HcalEndcap_bwd_layers=19+25+34;  
...
cout << " -----------------total sint. area for lowE_Fhe det. (m^2) = " << sumscint << endl;//total scintillator area for lowE_Fhe det.
return 0;
