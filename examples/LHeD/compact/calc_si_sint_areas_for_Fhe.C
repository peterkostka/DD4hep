...
//for compact_Fhe_dip_sol_ell.xml
//-------------------------------------------------------------------------------------------------
{gROOT->Reset();
...
float VertexBarrel_r3=VertexBarrel_r2 + VxBar_Env + Distance_VXDLayer; 
...
int HcalPlug_fwd_layers=71+152+170;
...
int HcalPlug_bwd_layers=58+110+147;
...
int EcalPlug_bwd_layers=1+34+27;
...
cout << " -----------------total Si area for Fhe det. (m^2) = " << sumall << endl;//total Silicon area 
float number_of_reaout_channel=sumall*47059;
cout << " -----------------number of readout channels for Fhe det. = " << number_of_reaout_channel << endl;//number of readout channel
...
float Ftd_disk_z10= 520.0; //cm
float Btd_disk_z8 = -390.0;//cm
float EcalBarrel_zmax=Ftd_disk_z10+(-Btd_disk_z8)+2.;//!!

float Kapton_thickness= 0.03;//cm
float Polys_thickness=0.8;
...
int HcalBarrel_layers1=20;
int HcalBarrel_layers2=30;
int HcalBarrel_layers3=40;

float Steel235_thickness1=2.2;//cm
float Steel235_thickness2=2.5;//cm
float Steel235_thickness3=3.0;//cm

float Polys_thickness_H=0.50; //!!!!!i did not use 0.60
...
float HcalBarrel_thickness=57.0+94.5+146.0;
...
int HcalEndcap_fwd_layers=35+40+44;
...
int HcalEndcap_bwd_layers=26+35+41; 
...
cout << " -----------------total sint. area for Fhe det. (m^2) = " << sumscint << endl;//total scintillator area for FHe det.
return 0;
